...
INSERT INTO users (id, email, password, full_name, bio, location, avatar_url, role, average_rating, completed_exchanges, created_at, updated_at) VALUES
(1, 'admin@skillswap.com', '$2a$10$vD2m3a8wRoxp5P9N7fNGeOzP6X3pWlD2vYI/nKj64a8Klh6qI5cve', 'System Administrator', 'Main administrator for SkillSwap platform.', 'New York, USA', 'https://api.dicebear.com/7.x/bottts/svg?seed=admin', 'ADMIN', 5.0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
